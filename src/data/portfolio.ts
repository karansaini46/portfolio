  ...
  projects: [
    {
      ...
      shortDescription: "AI-powered platform for creating, managing, and executing Standard Operating Procedures. Turns complex business workflows into structured, searchable, and reusable SOPs with AI assistance.",
      fullDescription: "AI-powered platform for creating, managing, and executing Standard Operating Procedures. Turns complex business workflows into structured, searchable, and reusable SOPs with AI assistance.",
      problem: "",
      targetUsers: [],
      features: [],
      stack: ["Next.js", "TypeScript", "Node.js", "PostgreSQL", "Prisma", "AI Integration"],
      highlights: [],
      liveUrl: "",
      githubUrl: "",
      featured: false,
      ...
      architecture: [],
      screenshots: [],
      description: "AI-powered platform for creating, managing, and executing Standard Operating Procedures. Turns complex business workflows into structured, searchable, and reusable SOPs with AI assistance.",
    ...
    },
    {
      ...
      type: "SaaS Platform",
      badge: "Under Development",
      shortDescription: "A five-in-one SaaS platform for small businesses that combines uptime monitoring, privacy-friendly analytics, SEO rank tracking, review monitoring, and appointment reminders into one unified dashboard.",
      fullDescription: "A five-in-one SaaS platform for small businesses that combines uptime monitoring, privacy-friendly analytics, SEO rank tracking, review monitoring, and appointment reminders into one unified dashboard.",
      problem: "",
      targetUsers: [],
      features: [],
      ...
      architecture: [],
      screenshots: [],
      description: "A five-in-one SaaS platform for small businesses that combines uptime monitoring, privacy-friendly analytics, SEO rank tracking, review monitoring, and appointment reminders into one unified dashboard.",
      status: "in-development",
      category: "saas",
    },
    {
      ...
      type: "AI Agent",
      badge: "Under Development",
      shortDescription: "An autonomous GitHub AI agent that reads GitHub issues, writes code fixes, runs tests inside isolated sandboxes, and automatically opens pull requests with zero human intervention.",
      fullDescription: "An autonomous GitHub AI agent that reads GitHub issues, writes code fixes, runs tests inside isolated sandboxes, and automatically opens pull requests with zero human intervention.",
      problem: "",
      targetUsers: [],
      features: [],
      stack: ["Node.js 22", "TypeScript", "LangChain", "Gemini 2.5", "BullMQ", "Redis", "PostgreSQL", "Prisma", "React", "Vite"],
      highlights: [],
      liveUrl: "",
      githubUrl: "",
      featured: false,
      ...
      architecture: [],
      screenshots: [],
      description: "An autonomous GitHub AI agent that reads GitHub issues, writes code fixes, runs tests inside isolated sandboxes, and automatically opens pull requests with zero human intervention.",
      status: "in-development",
      category: "ai",
    },
    {
